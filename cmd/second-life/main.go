...
import (
	...
	storagev1connect "github.com/pro0o/second-life/gen/bowie/v1/storagev1connect"
	...
	"github.com/pro0o/second-life/internal/handler"
)
...
func run() int {
	...
	logger := log.With().Str("service", "github.com/pro0o/second-life").Logger()
	err := godotenv.Load()
